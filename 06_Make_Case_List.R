...
write.table(md, file = "output/d_cases_java.csv", append = FALSE, quote = FALSE, 
...
saveRDS(object = cases_corrected, file = paste0("output/matching_data_caselist.rda"))
# cases_corrected <- readRDS(file = paste0("output/matching_data_caselist.rda"))

# ADD A 1KM JITTER TO ADDRESS ANONMIZATION ISSUES? AND SAVE AS ANON CASE DATA?
